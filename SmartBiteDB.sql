...
CREATE TABLE `fp_recipes` (
  ...
  `cuisine` VARCHAR(50) COLLATE utf8_unicode_ci NOT NULL,            -- e.g. 'American', 'Asian', 'Mexican', 'Italian'
  `meal_type` VARCHAR(50) COLLATE utf8_unicode_ci NOT NULL,          -- e.g. 'Breakfast', 'Lunch', 'Dinner'
  `diet` VARCHAR(30) COLLATE utf8_unicode_ci NOT NULL,               -- e.g. 'Omnivore', 'Vegetarian', 'Vegan', 'Pescatarian'
  `budget_level` VARCHAR(20) COLLATE utf8_unicode_ci NOT NULL,      -- e.g. 'Low Cost', 'Regular', 'Treat'
  `price` DECIMAL(6,2) NOT NULL,                                     -- estimated price per serving
...
(`recipe_id`, `title`, `cuisine`, `meal_type`, `diet`, `budget_level`, `price`, `cook_time`, `health_goal`, `img_url`,
 `fat`, `carb`, `protein`, `ingredients`, `instructions`)
VALUES
(1, 'Chicken Salad', 'American', 'Lunch', 'Omnivore', 'Low Cost', 3.50, 25, 'Low Carb', 'img/chicken_salad.jpg',
  9, 2, 24,
...
(2, 'Veggie Stir Fry', 'Asian', 'Dinner', 'Vegan', 'Low Cost', 2.50, 20, 'Low Fat', 'img/veggie_stir_fry.jpg',
  8, 35, 10,
...
(3, 'Beef Burrito Bowl', 'Mexican', 'Dinner', 'Omnivore', 'Regular', 5.00, 30, 'High Protein', 'img/beef_burrito_bowl.jpg',
 15, 45, 28,
...
(4, 'Tofu Buddha Bowl', 'Asian', 'Lunch', 'Vegan', 'Low Cost', 3.00, 25, 'High Protein', 'img/tofu_buddha_bowl.jpg',
 14, 40, 22,
...
(5, 'Pesto Pasta', 'Italian', 'Dinner', 'Vegetarian', 'Regular', 4.50, 20, 'None', 'img/pesto_pasta.jpg',
 18, 55, 15,
...
(6, 'Overnight Oats', 'American', 'Breakfast', 'Vegetarian', 'Low Cost', 1.50, 5, 'Low Fat', 'img/overnight_oats.jpg',
 6, 40, 10,
...
(7, 'Greek Yogurt Parfait', 'American', 'Breakfast', 'Vegetarian', 'Low Cost', 2.00, 10, 'High Protein', 'img/yogurt_parfait.jpg',
 5, 25, 18,
 'Greek yogurt, granola, mixed berries, honey.',
 'Layer yogurt, berries and granola in a glass, drizzle with honey and serve chilled.'),

(8, 'Salmon Rice Bowl', 'Asian', 'Dinner', 'Pescatarian', 'Treat', 8.00, 30, 'High Protein', 'img/salmon_rice_bowl.jpg',
 18, 40, 32,
...
(9, 'Lentil Soup', 'Mediterranean', 'Lunch', 'Vegan', 'Low Cost', 2.00, 35, 'Low Fat', 'img/lentil_soup.jpg',
 7, 40, 18,
...
(10, 'Shrimp Fried Rice', 'Asian', 'Dinner', 'Pescatarian', 'Regular', 5.50, 25, 'None', 'img/shrimp_fried_rice.jpg',
 14, 45, 22,
...
(11, 'Avocado Toast With Egg', 'American', 'Breakfast', 'Vegetarian', 'Low Cost', 3.00, 15, 'Low Carb', 'img/avocado_toast_egg.jpg',
 16, 20, 14,
...
(12, 'Turkey Chili', 'American', 'Dinner', 'Omnivore', 'Low Cost', 3.50, 40, 'High Protein', 'img/turkey_chili.jpg',
 10, 35, 28,
